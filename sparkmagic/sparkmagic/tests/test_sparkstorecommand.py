...
def test_to_command_pyspark():
    ...
    sparkcommand._pyspark_command.assert_called_with(variable_name, None)
...
def test_to_command_pyspark3():
    ...
    sparkcommand._pyspark_command.assert_called_with(variable_name, None, False)
...
def test_to_command_scala():
    ...
    sparkcommand._scala_command.assert_called_with(variable_name, None)
...
def test_to_command_r():
    ...
    sparkcommand._r_command.assert_called_with(variable_name, None)
...
def test_pyspark_livy_sampling_options():
    ...
    assert_equals(sparkcommand._pyspark_command(variable_name, None),
    ...
    sparkcommand = SparkStoreCommand(variable_name, samplemethod='sample', samplefraction=0.33, maxrows=3234)
    assert_equals(sparkcommand._pyspark_command(variable_name, None, False),
                  Command(u'for {} in {}.toJSON().sample(False, 0.33).take(3234): '
                          u'print({})'\
...
def test_scala_livy_sampling_options():
    ...
    assert_equals(sparkcommand._scala_command(variable_name, None),
...
def test_r_livy_sampling_options():
    ...
    assert_equals(sparkcommand._r_command(variable_name, None),
