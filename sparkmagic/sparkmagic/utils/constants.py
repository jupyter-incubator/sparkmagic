...
AUTH_KERBEROS_MUTUAL_REQ = 'required'
AUTH_KERBEROS_MUTUAL_OPT = 'optional'
AUTH_KERBEROS_MUTUAL_DIS = 'disabled'
AUTH_KERBEROS_MUTUAL_SUPPORTED = [AUTH_KERBEROS_MUTUAL_REQ, AUTH_KERBEROS_MUTUAL_OPT, AUTH_KERBEROS_MUTUAL_DIS]
