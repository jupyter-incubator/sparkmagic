...
from hdijupyterutils.configuration2 import override, override_all, with_override


# This is a sample implementation of how a module would use the config methods.
# We'll use these three functions to test it works. Only difference with a real
# implementation is that they would not pass an fsrw_class.
d = {}
path = "config.json"
original_value = 0
